...
void PushCommand()
{
  ...
  {
    bool saida1 = digitalRead(A0);
    digitalWrite(A0, !saida1); // O Operador ! inverte o status, se estava true com ! fica false
    EEPROM.write(MemSaveSaida1, !saida1);
    delay(1000);
  }
  ...
  {
    bool saida2 = digitalRead(A1);
    digitalWrite(A1, !saida2); // O Operador ! inverte o status, se estava true com ! fica false
    EEPROM.write(MemSaveSaida2, !saida2);
    delay(1000);    
  }

  //SAIDA3
 // if (digitalRead(CHAVE_3) == HIGH)
 // {
 //   bool saida3 = digitalRead(A4);
 //   digitalWrite(A2, !saida3); // O Operador ! inverte o status, se estava true com ! fica false
 //   EEPROM.write(MemSaveSaida3, !saida3);
 // }

  //SAIDA 4
 // if (digitalRead(CHAVE_4) == HIGH)
 // {
 //   bool saida4 = digitalRead(A3);
 //   digitalWrite(A3, !saida4); // O Operador ! inverte o status, se estava true com ! fica false
 //   EEPROM.write(MemSaveSaida4, !saida4);
 // }
